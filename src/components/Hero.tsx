    ...
    >
      ...
      <div className="relative mx-auto max-w-6xl px-4 sm:px-6">
        <motion.div
          ...
          className="mb-6 inline-flex items-center gap-2 rounded-full border border-slate-200 bg-white/80 px-3 py-1.5 text-xs font-medium text-slate-600 backdrop-blur dark:border-white/10 dark:bg-[#120e1c]/80 dark:text-zinc-400 sm:text-sm"
        >
        ...
        <motion.h1
          ...
          className="max-w-4xl text-4xl font-extrabold leading-tight tracking-tight text-slate-900 dark:text-white sm:text-5xl lg:text-6xl"
        >
        ...
        <motion.p
          ...
          className="mt-6 max-w-2xl text-base leading-relaxed text-slate-600 dark:text-zinc-400 sm:text-lg"
        >
          {copy.hero.subtitle}
        </motion.p>
